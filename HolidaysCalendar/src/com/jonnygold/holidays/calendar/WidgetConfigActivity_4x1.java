...
public class WidgetConfigActivity_4x1 extends Activity /*implements ColorPickerDialog.OnColorChangedListener*/ {
...
//        Log.w("WIDGET_DATA", ((CheckBox)findViewById(R.id.chk_rus)).isChecked() == true ? 1 : 0);
//        Log.w("WIDGET_DATA", ((CheckBox)findViewById(R.id.chk_rus)).isChecked() == true ? 1 : 0+"");
//        Log.w("WIDGET_DATA", ((CheckBox)findViewById(R.id.chk_rus)).isChecked() == true ? 1 : 0+"");
//        Log.w("WIDGET_DATA", ((CheckBox)findViewById(R.id.chk_rus)).isChecked() == true ? 1 : 0+"");
//        CommonResources.preferences.addWidgetData(
//        		mAppWidgetId, 
//        		((CheckBox)findViewById(R.id.chk_rus)).isChecked(), 
//        		((CheckBox)findViewById(R.id.chk_bel)).isChecked(), 
//        		((CheckBox)findViewById(R.id.chk_ukr)).isChecked(), 
